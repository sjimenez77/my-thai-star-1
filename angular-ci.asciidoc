...
sh """yarn ${testScript}"""
----
- angularDir: Directory where you can find the angular application. In My Thai Star this is the angular folder. The actual directory (.) is also allowed.
+
...
- sonarEnv: Name of the sonarQube environment.
+
